            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-2xl bg-stone-500/5 border border-stone-500/5 space-y-2">
                  ...
                  <p className="text-[11px] text-stone-400 leading-relaxed">
                    {rates.netPerMonth <= 0 ? (
                      `Warning: You are in a cash flow deficit (-₹${Math.abs(rates.netPerMonth).toLocaleString()} /mo). Optimize operating expenses immediately to restore a compounding surplus.`
                    ) : (
                      `Sustained wealth surplus! You are accumulating a net quiet surplus of ₹${rates.netPerMonth.toLocaleString('en-IN', { maximumFractionDigits: 0 })} every single month. Compound continues.`
                    )}
                  </p>
                </div>
